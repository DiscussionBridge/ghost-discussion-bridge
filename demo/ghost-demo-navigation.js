(() => {
  ...
  if (footer && !footer.querySelector("[data-discussionbridge-social-links]")) {
    ...
    const links = [
      ...
      ["X", "#", '<path d="M18.242 2.25h3.313l-7.23 8.258 8.503 11.242h-6.656l-5.219-6.816-5.96 6.816H1.68l7.726-8.836L1.258 2.25h6.824l4.71 6.23 5.45-6.23Zm-1.16 17.523h1.832L7.082 4.125H5.113l11.969 15.648Z"/>'],
